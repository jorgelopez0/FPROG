...
public class SegundoBorrador {
    ...
    public static void Opcion1(Scanner sc){
        ...
        //Inicializo dos matrices 
        char[][] matriz1 = new char[filas+1][columnas]; //en esta guardare los elementos de las filas pares: (0,2,4..)
        char[][] matriz2= new char[filas][columnas+4+filas]; //en esta guardaré los elementos de las filas impares
        //reservando espacios para los # y *
        
        //Inicializo 3 contadores para imprimir el tablero inicialmente
        int cont1=0;
        int cont2=0;
        int cont3=0;
        
        //Proceso para introducir el tablero inicialmente
        char posicion = 'A';
        ...
        //Empieza un jugador de manera aleatoria
        int numEmpezar = (int) (Math.random()*2);
        System.out.println("Jugador que empieza: " + (numEmpezar == 0 ? "Jugador 1" : "Jugador 2"));
        
        //Inicializo un boolean para ver quien empieza y el string jugador, ambos los usare mas adelante
        boolean empieza1;
        String jugador = "";
